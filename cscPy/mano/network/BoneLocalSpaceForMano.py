...
mano_right = MANO_SMPL('/home/csc/MANO-hand-model-toolkit/mano/models/MANO_LEFT.pkl', ncomps=45,oriorder=True,cuda='cpu')
F=mano_right.faces
...
tempJ=getBatch(mano_right.J)
tempV=getBatch(mano_right.v_template)
...
for bonei in range(15):
    ...
    bonespace.append(comebineRt3D(alignr.reshape(3,3),indexbone0J[:, bonei+1:bonei+2, :, :].reshape(-1)))
